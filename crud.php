...
?>  
    <section class="bg-cor" style="padding-top: 25px;">
        ...
        <div style="margin-bottom: 50px;">
            <a href="Postagem_adicionar.php" style="text-decoration: none;">
                                            ...
                                            <div class="card-header">
                                                <ul class="nav nav-tabs card-header-tabs" style="display: flex; justify-content: space-between">
                                                    <li class="nav-item" style="background-color: black; border-radius: 5px;">
                                                        <a class="nav-link" href="Postagem_alterar.php?id='.$linha["id"].'">Alterar</a>
                                                    </li>
                                                    <li class="nav-item" style="background-color: red; border-radius: 5px;">
                                                        <a class="nav-link" href="Postagem_excluir.php?id='.$linha["id"].'">Excluir</a>
                                                    </li>
                                                </ul>
                                            </div>
...
?>
        <div class="container bg-cor">
            <div class="row d-flex justify-content-center py-5">
                ...
                <div>
                    <a href="Membros_adicionar.php" style="text-decoration: none;">
                            ...
                            echo    '<div class="col">
                                        <div class="card text-white bg-'.$linha['cor'].' h-100">
                                            <div class="card-header">
                                                <ul class="nav nav-tabs card-header-tabs" style="display: flex; justify-content: space-between">
                                                    <li class="nav-item" style="background-color: black; border-radius: 5px;">
                                                        <a class="nav-link" href="Membros_alterar.php?id='.$linha["id"].'">Alterar</a>
                                                    </li>
                                                    <li class="nav-item" style="background-color: red; border-radius: 5px;">
                                                        <a class="nav-link" href="Membros_excluir.php?id='.$linha["id"].'">Excluir</a>
                                                    </li>
                                                </ul>
                                            </div>
